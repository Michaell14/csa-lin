...
select lives_ok($$ insert into public.lin_milestones(lin_id,title,event_date,created_by) values ('00000000-0000-0000-0000-0000000000a1','Launch','2026-09-14','00000000-0000-0000-0000-000000000002') $$, 'admin creates a milestone');
