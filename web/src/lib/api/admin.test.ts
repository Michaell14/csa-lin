...
import { listAdmins, mergePeople } from '@/lib/api/admin'
...
describe('listAdmins', () => {
  it('embeds only the people columns the table grants to signed-in users', async () => {
    const rows = [
      { granted_at: '2026-09-01T00:00:00Z', person: { id: SURVIVOR, display_name: 'Alice', grad_year: 2026 } },
    ...
    expect(admins).toEqual([{ person: { id: SURVIVOR, display_name: 'Alice', grad_year: 2026 }, granted_at: '2026-09-01T00:00:00Z' }])
  })
})
