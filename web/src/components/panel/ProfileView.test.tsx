...
const person = (id: string, name: string, year: number, extra: Partial<Person> = {}): Person => ({
  ...
  preferred_name: null, pronouns: null, school: null, current_city: null, interests: null, csa_role: null, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z', ...extra,
})
