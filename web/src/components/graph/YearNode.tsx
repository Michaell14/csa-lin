  ...
  return (
    <div style={{ width: data.width, height: NODE_H }} className="flex select-none items-center gap-4">
      <span
        ...
        className="shrink-0 whitespace-nowrap text-right text-xs font-medium uppercase tracking-wide text-ink-faint"
      >
        Class of {data.year}
      </span>
      <span aria-hidden className="h-px flex-1 bg-surface-active" />
    </div>
  )
}
