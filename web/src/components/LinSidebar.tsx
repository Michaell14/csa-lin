    ...
    <>
      ...
      >
          ...
          {lins.map(lin => {
            ...
            return (
              <button
                ...
                className={`flex h-9 items-center gap-2.5 rounded-md border px-2.5 text-left text-sm ${selected ? 'border-line bg-white font-medium text-ink' : 'border-transparent text-ink-body hover:bg-surface-hover'}`}
              >
        ...
        <div
          ...
          className="absolute inset-y-0 -right-1.5 w-3 cursor-col-resize hover:bg-line"
        />
      </aside>
    </>
  )
